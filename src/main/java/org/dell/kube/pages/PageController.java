...
public class PageController {
    ...
    public ResponseEntity<Page> create(@RequestBody Page page) {
        ...
        logger.info("CREATE-INFO:Creating a new record");
        logger.debug("CREATE-DEBUG:Creating a new record");

        Page newPage= pageRepository.create(page);

        logger.info("CREATE-INFO:Created successfully");
        logger.debug("CREATE-DEBUG:Created successfully");
